...
# Latency data (ms)
latency_data = {"large": [170, 1200, 6000], "small": [80, 320, 830]}
...
colors = {
    "large": "rgba(31, 119, 180, 0.7)",  # blue with 70% opacity
    "small": "rgba(255, 127, 14, 0.7)",  # orange with 70% opacity
}
...
fig.add_annotation(
    text="<b>Small vs. Large Model  (ml.g4dn.xlarge)</b>",
    xref="paper",
    yref="paper",
    x=0.5,
    y=1.09,
...
fig.write_image(
    "sagemaker_performance_comparison_small_large.png",
    width=900,
    height=1450,
...
print("✓ Chart saved as 'sagemaker_performance_comparison_small_large.png'")
